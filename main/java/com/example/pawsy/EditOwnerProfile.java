...
public class EditOwnerProfile extends AppCompatActivity {
    ...
    TextInputLayout fullname,phoneNo,country,city,password;
    String userStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditOwnerProfile.super.onBackPressed();
            }
        });
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnaphot){
                            ...
                            if (dataSnaphot.exists()) {
                                ...
                                Owner owner = new Owner(nameStr,countryStr,cityStr,userStr,passwordStr,emailStr,phoneNoStr);
                                ref.child(userStr).setValue(owner);
                            }
                        }
                ...
                Intent intent = new Intent(EditOwnerProfile.this, MainActivity.class);
