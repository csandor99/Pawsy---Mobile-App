...
public class EditPetsitterProfile extends AppCompatActivity {

    FirebaseDatabase rootNode;
    DatabaseReference ref;
    TextInputLayout fullname,phoneNo,country,city,price,description,password;
    String userStr;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_petsitter_profile);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditPetsitterProfile.super.onBackPressed();
            }
        });
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String priceStr = price.getEditText().getText().toString();
                    ...
                    checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnaphot){
                            ...
                            if (dataSnaphot.exists()) {
                                ...
                                PetSitter petSitter = new PetSitter(nameStr,countryStr,cityStr,userStr,passwordStr,emailStr,phoneNoStr,descriptionStr,priceStr);
                                ref.child(userStr).setValue(petSitter);
                            }
                        }
                ...
                Intent intent = new Intent(EditPetsitterProfile.this, MainActivity.class);
